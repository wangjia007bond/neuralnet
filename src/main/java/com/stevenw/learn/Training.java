...
import com.stevenw.neuralnet.InputLayer;
import com.stevenw.neuralnet.NeuralNet;
import com.stevenw.neuralnet.Neuron;
...
public abstract class Training {
	...
	public void printTrainedNetResult(NeuralNet trainedNet) {
		...
		for(int i = 0; i < rows; i++) {
			...
			System.out.println(" NET OUTPUT: " + estimatedOutput + "\t");
			System.out.println(" REAL OUTPUT: " + trainedNet.getRealOutputSet()[i] + "\t");
